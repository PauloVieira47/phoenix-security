...
const statusItems = [
  { label: "MODULES", value: String(solutions.length).padStart(2, "0") },
    ...
    <>
        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl lg:text-6xl">
              ...
              <br />
              <span className="text-white/45">de segurança.</span>
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-relaxed text-text-secondary sm:text-lg">
              ...
              acesso. De {localBusiness.city} à Grande São Paulo.
            </p>
          </motion.div>
      ...
      <section className="relative border-t border-white/5 pb-20 pt-4 md:pb-28">
        ...
        <Container className="relative">
          {/*
            4 colunas: destaque 2x2 + 2 + 2 + 4 = grade cheia, sem vãos.
          */}
          ...
          >
            <div>
              ...
              <p className="mt-2 max-w-md text-sm text-text-secondary">
                Avaliamos o empreendimento e indicamos o conjunto certo de
                soluções para a sua operação.
              </p>
            </div>
    ...
    >
      ...
      >
        ...
        <span className="mt-5 inline-flex items-center gap-1.5 text-sm font-medium text-phoenix transition-all group-hover:gap-2.5">
          {featured ? "Explorar solução" : "Saiba mais"}
