...
export function MaintenanceIllustration({
  ...
  return (
    <div
      className={cn(
        "relative mx-auto flex h-20 w-20 items-center justify-center sm:h-24 sm:w-24",
        className,
      )}
      aria-hidden
    >
      <div className="absolute inset-0 rounded-full bg-phoenix/10 blur-2xl maintenance-glow" />
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 16 16"
        className="relative h-full w-full text-phoenix construction-phoenix-float"
      >
